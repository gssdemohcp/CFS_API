sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14819017062921644_S4", {
		...
		//===================================
		rowCount: function() {
			if (OpenBillingDocuments.OpenBillSet.length <= 7) {
				this.getView().byId("obdtable").setVisibleRowCount(OpenBillingDocuments.OpenBillSet.length);
			} else {
		...
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Netwr", sap.ui.model.FilterOperator.GT, '25001.00');
