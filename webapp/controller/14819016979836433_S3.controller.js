sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14819016979836433_S3", {
		...
		//===================================
		rowCount: function() {
			if (salesDocumentSearch.salesDocumentSearchSet.length <= 7) {
				this.getView().byId("table").setVisibleRowCount(salesDocumentSearch.salesDocumentSearchSet.length);
			} else {
		...
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Auart", sap.ui.model.FilterOperator.EQ, 'Standard Order');
