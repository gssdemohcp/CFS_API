sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14819017226063143_S6", {
		...
		rowCount: function() {
			if (openQuotations.OpenQuotationSet.length <= 7) {
				this.getView().byId("table").setVisibleRowCount(openQuotations.OpenQuotationSet.length);
			} else {
		...
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Matnr", sap.ui.model.FilterOperator.EQ, 'M-111');
