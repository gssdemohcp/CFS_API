sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14819017384062359_S8", {
		...
		rowCount: function() {
			if (ContactPerson.cpset.length <= 7) {
				this.getView().byId("contactPerson").setGrowingThreshold(ContactPerson.cpset.length);
			} else {
		...
		filterGlobally: function(oEvent) {
			...
			var filters = [];
			if (sQuery) {
				filters = [new sap.ui.model.Filter([new sap.ui.model.Filter("Prsnr", sap.ui.model.FilterOperator.Contains, sQuery)])];
			}
		...
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Namev", sap.ui.model.FilterOperator.EQ, 'Michael');
