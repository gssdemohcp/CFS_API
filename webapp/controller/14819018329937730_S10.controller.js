sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14819018329937730_S10", {
		...
		rowCount: function() {
			if (BillingDocument.BillingDocSet.length <= 7) {
				this.getView().byId("bdtable").setVisibleRowCount(BillingDocument.BillingDocSet.length);
			} else {
		...
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Netwr", sap.ui.model.FilterOperator.GT, '30000.00');
